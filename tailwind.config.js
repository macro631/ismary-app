  ...
  theme: {
    extend: {
      colors: {
        ...
        "outline-variant": "#e2d3db",
        "on-error": "#ffffff",
        "on-tertiary-container": "#e0b05d",
        "on-secondary-container": "#795a67",
        "surface-variant": "#e4e2e1",
        primary: "#7a2e50",
        // Tono más profundo para hover/pressed de la acción principal.
        "primary-strong": "#5e1739",
        "on-secondary": "#ffffff",
        "surface-dim": "#dcd9d9",
        error: "#ba1a1a",
        ...
        // Tokens de marca de design-system.md (raíz del proyecto).
        "brand-soft": "#f7e6eb",
        "brand-medium": "#e8c1d0",
        "brand-primary": "#7a2e50",
      ...
      // Escala según design-system.md §4: 16px base, 14px mínimo para texto
      // auxiliar; 12px solo en etiquetas cortas.
      fontSize: {
        ...
        "code-clinical": ["14px", { lineHeight: "20px", fontWeight: "500" }],
